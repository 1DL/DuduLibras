...
import pontuacao.nivel2_1;

public class FrmNivel2_2 extends javax.swing.JFrame {

    private static int codUsuario;
    private static int pontuacao;
    static LogSessao logNv22 = new LogSessao();
    Timer tempoSessao;
    public int contador = 22;
    Timer t;
    Sons sfx = new Sons();
    ...
    /**
     * Creates new form Frm_Nivel2_2
     */
    public FrmNivel2_2(int codigo, LogSessao logHerdado) {
        codUsuario = codigo;
        logHerdado.zeraLog();
        logNv22 = logHerdado;
        initComponents();
...
//    
    public int[] flagCartaPontuada = new int[15];
    ...
    String[] valorCarta = new String[15];
    ...
    public int[] flagClicavel = new int[15];
    ...
    private void initComponents() {
        ...
        descricao_nivel21 = new javax.swing.JLabel();
        ...
        btncarta1.setBounds(130, 190, 120, 150);
        ...
        btncarta2.setBounds(250, 190, 120, 150);
        ...
        btncarta3.setBounds(370, 190, 120, 150);
        ...
        btncarta4.setBounds(490, 190, 120, 150);
        ...
        btncarta5.setBounds(610, 190, 120, 150);
        ...
        btncarta6.setBounds(730, 190, 120, 150);
        ...
        btncarta7.setBounds(850, 190, 120, 150);
        ...
        btncarta8.setBounds(130, 350, 120, 150);
        ...
        btncarta9.setBounds(250, 350, 120, 150);
        ...
        btncarta10.setBounds(370, 350, 120, 150);
        ...
        btncarta11.setFocusPainted(false);
        ...
        btncarta11.setBounds(490, 350, 120, 150);
        ...
        btncarta12.setFocusPainted(false);
        ...
        btncarta12.setBounds(610, 350, 120, 150);
        ...
        btncarta13.setFocusPainted(false);
        ...
        btncarta13.setBounds(730, 350, 120, 150);
        ...
        btnAvancar.setBounds(1010, 520, 230, 190);
        ...
        btnAjuda.setBounds(1070, 10, 220, 160);
        ...
        btncarta14.setFocusPainted(false);
        ...
        btncarta14.setBounds(850, 350, 120, 150);
        ...
        jogodamemoria.setBounds(240, 80, 520, 70);

        descricao_nivel21.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/descricao_2.2.png"))); // NOI18N
        getContentPane().add(descricao_nivel21);
        descricao_nivel21.setBounds(30, 30, 710, 50);
    ...
    private void btnAjudaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAjudaActionPerformed
        JdiAjuda ajuda = new JdiAjuda(this, rootPaneCheckingEnabled, 7);
        ajuda.setModal(true);
        ...
        if ((flagClicavel[1] == 1) || (flagCartaPontuada[1] == 1)) {
            ...
            } else if (flagVirada == 1) //Valida se já teve uma carta clicada antes
            {
                ...
                // true
                {
                    ...
                    msg.setVisible(true);
                    logNv22.setAcertos(logNv22.getAcertos() + 1);
                    logNv22.setPontosGanhos(logNv22.getPontosGanhos() + 200);
                    logNv22.setPontosTotais(logNv22.getPontosTotais() + 200);
                ...
                } else //Caso o retorno do metodo comparacao seja false, significa que a primeira e segunda carta não são iguais
                {
                    ...
                    msg.setLocation(100, 100);
                    msg.setVisible(true);
                    logNv22.setErros(logNv22.getErros() + 1);
                    logNv22.setPontosPerdidos(logNv22.getPontosPerdidos() + 10);
                    logNv22.setPontosTotais(logNv22.getPontosTotais() - 10);
    ...
    private void btnAvancarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAvancarActionPerformed
        ...
        gerarLogEncerrar();
        FrmAtividade2_2 telaAtividade = new FrmAtividade2_2(codUsuario, logNv22);
    ...
    private void btnSelecNivelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelecNivelActionPerformed
        ...
        gerarLogEncerrar();
        tempoSessao.stop();
        FrmTelaNivel telaNivel = new FrmTelaNivel(nome, codUsuario, logNv22);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmNivel2_2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new FrmNivel2_2(codUsuario, logNv22).setVisible(true);
            }
        });
    }
    ...
    private void gerarLog() {
        ...
        salvarLog.gerarLogSessao("nv22", logNv22);
        tempoSessao.stop();
    }
...
t2.stop();t.stop();
        ...
        logNv22.setHoraFimSessao(formatoData.format(dataSessao) + " " + formatoHora.format(dataSessao));
        logNv22.setPontuacaoTotalSessao(logNv22.getPontosTotais() + logNv22.getPontuacaoTotalSessao());

        logNv22.setTempoSessao("" + logNv22.hor + ":" + logNv22.min + ":" + logNv22.seg);
        tempoSessao.stop();


        salvarLog.gerarLogEncerrarSessao("nv22", logNv22);
    ...
    public void embaralhar() {
        cartas.addAll(Arrays.asList("/Cartas_nvl2_1/cartinhaj.png", "/Cartas_nvl2_1/cartinhaj.png", "/Cartas_nvl2_1/cartinhak.png", "/Cartas_nvl2_1/cartinhak.png", "/Cartas_nvl2_1/cartinhal.png", "/Cartas_nvl2_1/cartinhal.png", "/Cartas_nvl2_1/cartinham.png", "/Cartas_nvl2_1/cartinham.png", "/Cartas_nvl2_1/cartinhan.png", "/Cartas_nvl2_1/cartinhan.png", "/Cartas_nvl2_1/cartinhap.png", "/Cartas_nvl2_1/cartinhap.png", "/Cartas_nvl2_1/cartinhaq.png", "/Cartas_nvl2_1/cartinhaq.png"));
    ...
    private void finalizaAtividade() {
        ...
        for (int i = 1; i <= 14; i++) {
            ...
            if (aux == 14) {
                ...
                JdiDesempenhoNivel stats = new JdiDesempenhoNivel(this, rootPaneCheckingEnabled, logNv22, pontuacao);
                stats.setModal(true);
    ...
    private javax.swing.JLabel descricao_nivel21;
